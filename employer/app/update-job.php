...
$stmt = $conn->prepare("UPDATE tbl_jobs SET title = :title, city = :city, barangay = :barangay, category = :category, type = :type, experience = :experience, description = :description, responsibility = :responsibility, requirements = :requirements WHERE job_id = :jobid AND company = '$myid'");
