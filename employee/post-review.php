...
if($_SESSION['role'] != 'employee') $disabled = 'disabled'; 
    ...
    <form action="employee/app/post-review.php" method="POST" enctype="multipart/form-data">			
        ...
        <div class="admin-content-wrapper">
            ...
            <div class="form-group bootstrap3-wysihtml5-wrapper">
                <label for=""></label>
                <textarea  <?php echo $disabled ?>  name="review" class="bootstrap3-wysihtml5 form-control" placeholder="Enter your short review ..." style="height: 200px;"><?php echo "$mydesc"; ?></textarea>
            </div>
